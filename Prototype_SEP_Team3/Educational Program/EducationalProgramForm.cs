...
{
    public partial class EducationalProgramForm : Form
    {
        ...
        string itemcontent = "";
        int itemposition = 0;
        public EducationalProgramForm()
        {
            InitializeComponent();
            this.WindowState = FormWindowState.Maximized;

            wbCơsởvậtchất.Navigate("\\ckeditor.html");
            wbKhốilượngkt.Navigate("\\ckeditor.html");
            wbĐốitượng.Navigate("\\ckeditor.html");
            wbQuytrình.Navigate("\\ckeditor.html");
